...
df = pd.DataFrame({'직무':['생산기술', '대외협력', '환경안전', '연구개발', '구매', '소프트웨어 연구개발', '경영관리', '인사', '품질/서비스', '영업', '법무', '마케팅', 'SCM/물류', '재무', '디자인', '제조'],
                  '현재인원':[2341.3, 33.2, 149.5, 4607.5, 192.7, 1354.2, 258.1, 304.1, 520.6, 337.9, 67.2, 377.2, 63.2, 87.0, 168.4, 1242.2],
                  '대체후인원':[2106.4, 29.9, 134.0, 4114.4, 169.1, 1177.5, 221.6, 259.8, 444.0, 287.4, 57.2, 317.5, 52.8, 70.9, 133.9, 973.9],
                  '대체율':[0.100328877119549, 0.09939759036144591, 0.10367892976588629, 0.1070211611502985, 0.12247016087182146, 0.13048294195835183, 0.1414180550174352, 0.1456757645511345, 0.1471379177871687, 0.14945250073986388, 0.1488095238095238, 0.158271474019088, 0.16455696202531653, 0.18505747126436775, 0.20486935866983372, 0.21598776364514577]
                    })
